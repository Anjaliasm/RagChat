...
def get_text_chunks(text, model_name):
    if model_name == "Google AI":
        ...
        # Default splitter if other models are added in the future
...
def main():
    ...
    linkedin_profile_link = "https://www.linkedin.com/in/anjali-mishra-339a9523b"
    github_profile_link = "https://github.com/Anjaliasm"
